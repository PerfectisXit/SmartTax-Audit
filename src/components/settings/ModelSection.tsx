...
export const ModelSection: React.FC<ModelSectionProps> = ({
  ...
  modelPlaceholder = "请输入模型名称，例如: Pro/moonshotai/Kimi-k2.5"
}) => {
  return (
    <div>
      ...
      <div className="relative group">
        <input
          ...
          className={`w-full px-4 pr-10 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none bg-white text-sm text-gray-700 font-mono ${modelInputDisabled ? 'opacity-70 cursor-not-allowed' : ''}`}
          autoComplete="off"
        />
        <button
          type="button"
