...
export type DuplicateStatus = 'none' | 'pending_review' | 'confirmed_duplicate' | 'confirmed_distinct';
...
export interface DuplicateGroup {
  ...
  estimatedDuplicateAmount: number;
}

export interface TravelDedupSummary {
